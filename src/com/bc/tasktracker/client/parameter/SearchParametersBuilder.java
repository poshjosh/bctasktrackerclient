...
//        final Logger logger = Logger.getLogger(this.getClass().getName());
        ...
        final Date from = builder.calendar(cal)
                ...
                .build(null);
        if(from != null) {
System.out.println("============================ From: "+from+" "+this.getClass().getName());            
        ...
        final Date to = builder.calendar(cal)
                ...
                .build(null);
        if(to != null) {
System.out.println("============================   To: "+to+" "+this.getClass().getName());            
            cal.setTime(from);
            cal.add(Calendar.HOUR_OF_DAY, 24);
System.out.println("============================  -To: "+cal.getTime()+" "+this.getClass().getName());                        
