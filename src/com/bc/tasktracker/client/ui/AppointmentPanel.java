...
public class AppointmentPanel extends javax.swing.JPanel {
     ...
     * @param app
     */
    public AppointmentPanel(TasktrackerApp app) {
        initComponents();
        if(app != null) {
            this.parentAppointmentComboBox.setModel(new DefaultComboBoxModel(
                    app.getAppointmentNames()
            ));
            this.unitComboBox.setModel(new DefaultComboBoxModel(
                    app.getUnitNames()
            ));
            this.addAppointmentButton.setActionCommand(TasktrackerActionCommands.ADD_APPOINTMENT);
            this.createNewUnitForAppointmentButton.setActionCommand(TasktrackerActionCommands.DISPLAY_UNIT_UI);
